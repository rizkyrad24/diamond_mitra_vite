    ...
    <div class="w-[684.92px] rounded-lg shadow-lg bg-[#FFFFFF] border-collapse pb-12">
      ...
      <div class="w-full h-[400px] overflow-y-auto px-10 pb-5">
        ...
        <div
          ...
          class="mb-4"
        >
          <label class="text-[#4D5E80] font-medium">Nama Bidang<span class="text-[#FF5656]">*</span></label>
          <form
            action=""
              ...
              >
                ...
                <td class="p-2 py-4 border border-[#E5E7E9] relative">
                  ...
                  >
                    ...
                    <button
                      class="block w-full flex-grow px-4 py-2 text-[14px] font-sans font-normal text-[#333333] text-left hover:bg-[#DBEAFE]"
                      @click="SendDeleteBidang(item.id)"
                    >
                      Hapus
                    </button>
                  </div>
  ...
  methods: {
    ...
    SendCreateBidang() {
      this.modalDialog = {
        ...
        okFunction: this.openCreateBidang,
        closeFunction: this.closeCreateBidang
      }
    },
    openCreateBidang() {
      this.closeModalDialog();
      this.postCreateBidang(this.successCreateBidang, this.failCreateBidang);
    },
    closeCreateBidang() {
      this.closeModalDialog()
    },
    successCreateBidang() {
      this.modalSuccess = {
        isVisible: true,
        title: 'Berhasil',
        message: 'Berhasil membuat Bidang baru',
        closeFunction: this.closeSelesaiCreateBidang
      }
    },
    failCreateBidang(data) {
      this.modalFailed = {
        isVisible: true,
        title: 'Gagal',
    ...
    SendEditBidang() {
      this.modalDialog = {
        ...
        title: 'Konfirmasi',
        message: 'Apakan anda yakin dengan data yang anda masukan',
        okFunction: this.openEditBidang,
        closeFunction: this.closeEditBidang
      }
    },
    openEditBidang() {
      this.closeModalDialog();
      this.postEditBidang(this.successEditBidang, this.failEditBidang);
    },
    closeEditBidang() {
      this.closeModalDialog()
    },
    successEditBidang() {
      this.modalSuccess = {
        isVisible: true,
        title: 'Berhasil',
        message: 'Berhasil mengedit Bidang',
        closeFunction: this.closeSelesaiEditBidang
      }
    },
    failEditBidang(data) {
      this.modalFailed = {
    ...
    SendDeleteBidang(id) {
      ...
      this.modalDialog = {
        isVisible: true,
        title: 'Konfirmasi',
        message: 'Apakan anda yakin menghapus Bidang ini',
        okFunction: this.openDeleteBidang,
        closeFunction: this.closeDeleteBidang
      }
    },
    openDeleteBidang() {
      this.closeModalDialog();
      this.postDeleteBidang(this.successDeleteBidang, this.failDeleteBidang);
    },
    closeDeleteBidang() {
      this.closeModalDialog()
    },
    successDeleteBidang() {
      this.modalSuccess = {
        ...
        closeFunction: this.closeSelesaiDeleteBidang
      }
    },
    failDeleteBidang(data) {
      this.modalFailed = {
        isVisible: true,
        title: 'Gagal',
        message: data?.message ? data.message : "Silahkan hubungi admin"
    ...
    async postCreateBidang(successFunction, failFunction) {
      this.isLoading = true;
    ...
    async postEditBidang(successFunction, failFunction) {
      this.isLoading = true;
      const form = new FormData()
      form.append('name', this.name);
      form.append('description', this.description);
