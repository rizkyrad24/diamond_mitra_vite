    ...
    <div class="w-[684.92px] rounded-lg shadow-lg bg-[#FFFFFF] border-collapse pb-12">
      ...
      <div class="w-full h-[400px] overflow-y-auto px-10 pb-5">
        <div
          ...
          class="mb-4"
        >
          <label class="text-[#4D5E80] font-medium">Nama Direktorat<span class="text-[#FF5656]">*</span></label>
          <form
            action=""
              ...
              >
                ...
                <td class="p-2 py-4 border border-[#E5E7E9] relative">
                  ...
                  >
                    ...
                    <button
                      class="block w-full flex-grow px-4 py-2 text-[14px] font-sans font-normal text-[#333333] text-left hover:bg-[#DBEAFE]"
                      @click="SendDeleteDirektorat(item.id)"
                    >
                      Hapus
                    </button>
                  </div>
...
export default {
  ...
  methods: {
    ...
    // Popup Create
    SendCreateDirektorat() {
      this.modalDialog = {
        isVisible: true,
        title: 'Konfirmasi',
        message: 'Apakan anda yakin dengan data yang anda masukan',
        okFunction: this.openCreateDirektorat,
        closeFunction: this.closeCreateDirektorat
      }
    },
    openCreateDirektorat() {
      this.closeModalDialog();
      this.postCreateDirektorat(this.successCreateDirektorat, this.failCreateDirektorat);
    },
    closeCreateDirektorat() {
      this.closeModalDialog()
    },
    successCreateDirektorat() {
      this.modalSuccess = {
        isVisible: true,
        title: 'Berhasil',
        message: 'Berhasil membuat Direktorat baru',
        closeFunction: this.closeSelesaiCreateDirektorat
      }
    },
    failCreateDirektorat(data) {
      this.modalFailed = {
        isVisible: true,
        title: 'Gagal',
    ...
    SendEditDirektorat() {
      this.modalDialog = {
        ...
        title: 'Konfirmasi',
        message: 'Apakan anda yakin dengan data yang anda masukan',
        okFunction: this.openEditDirektorat,
        closeFunction: this.closeEditDirektorat
      }
    },
    openEditDirektorat() {
      this.closeModalDialog();
      this.postEditDirektorat(this.successEditDirektorat, this.failEditDirektorat);
    },
    closeEditDirektorat() {
      this.closeModalDialog()
    },
    successEditDirektorat() {
      this.modalSuccess = {
        isVisible: true,
        title: 'Berhasil',
        message: 'Berhasil mengedit Direktorat',
        closeFunction: this.closeSelesaiEditDirektorat
      }
    },
    failEditDirektorat(data) {
      this.modalFailed = {
        isVisible: true,
        title: 'Gagal',
        message: data?.message ? data.message : "Silahkan hubungi admin"
    ...
    // Popup Delete Direktorat
    SendDeleteDirektorat(id) {
      this.direktoratId = id
      this.modalDialog = {
        isVisible: true,
        title: 'Konfirmasi',
        message: 'Apakan anda yakin menghapus Direktorat ini',
        okFunction: this.openDeleteDirektorat,
        closeFunction: this.closeDeleteDirektorat
      }
    },
    openDeleteDirektorat() {
      this.closeModalDialog();
      this.postDeleteDirektorat(this.successDeleteDirektorat, this.failDeleteDirektorat);
    },
    closeDeleteDirektorat() {
      this.closeModalDialog()
    },
    successDeleteDirektorat() {
      this.modalSuccess = {
        isVisible: true,
        title: 'Berhasil',
        message: 'Berhasil menghapus Direktorat',
        closeFunction: this.closeSelesaiDeleteDirektorat
      }
    },
    failDeleteDirektorat(data) {
      this.modalFailed = {
        isVisible: true,
        title: 'Gagal',
        message: data?.message ? data.message : "Silahkan hubungi admin"
    ...
    async postCreateDirektorat(successFunction, failFunction) {
      this.isLoading = true;
    ...
    async postEditDirektorat(successFunction, failFunction) {
      this.isLoading = true;
      const form = new FormData()
      form.append('name', this.name);
      form.append('description', this.description);
