<template>
  <div class="flex items-center justify-center w-[1366px] h-full bg-[#F6F0F0] shadow-xl">
    ...
    <div class="relative self-start mt-[150px] flex justify-center">
      ...
      >
      <div class="absolute mt-[325px] inset-0 flex items-center justify-center">
        <div class="custom-bg w-[588px] h-[156px] rounded-md text-center flex flex-col items-center justify-center">
          ...
          <h1 class="text-[#E9EAEC] font-sans font-semibold text-[25px]">
    ...
    <div class="w-[480px] h-[496px] bg-[#F6F0F0] mr-[60px]">
      ...
      >
        <rect
          ...
          width="251"
          height="44"
          fill="url(#pattern0_2285_24014)"
        />
        <defs>
          <pattern
            id="pattern0_2285_24014"
            patternContentUnits="objectBoundingBox"
            width="1"
            height="1"
          >
            <use
              xlink:href="#image0_2285_24014"
              transform="scale(0.00398406 0.0227273)"
            />
          </pattern>
          <image
        ...
        <div class="w-[480px] h-[168px] bg-[#F6F0F0] mt-8">
          ...
          <div class="flex flex-col w-[480px] h-[72px] bg-[#F6F0F0] mt-6">
            <div class="flex items-center">
              ...
              <h2 class="text-[#FF5656] font-bold">
                *
              </h2>
            </div>
