  ...
  <div>
    <div class="flex w-auto h-[54px] rounded-lg bg-[#FFFFFF] border-collapse">
      <button @click="navigateToDetail">
        <h1 class="w-[51px] h-[22px] font-sans text-[#2671D9] text-[14px] font-semibold ml-6 mr-2 mt-4 mb-4">Approval
        </h1>
      </button>
    ...
    <div class="px-4 py-3">
      <div class="relative h-auto w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
        ...
        <div class="flex flex-row w-[1046px] h-auto ml-4 py-9">
          <button @click="SendTolak" class="absolute bottom-[12px] right-[123px] mt-4 flex">
            <div
              class="flex items-center justify-center w-[69px] h-[40px] rounded-lg bg-[#FFFFFF] border-[#C53830] border-[1px] hover:bg-[#FEE2E2] cursor-pointer transition-all">
              <span class="text-[14px] font-sans text-[#C53830] font-semibold ml-3 mt-[9px] mr-3 mb-[9px]">Reject</span>
            </div>
          </button>
          <button @click="SendApprov" class="absolute bottom-[12px] right-[24px] flex">
            <div
              class="flex items-center justify-center w-[83px] h-[40px] rounded-lg bg-[#2671D9] hover:bg-[#1E5BB7] border-[#FFFFFF] border-[1px]">
              <span
                class="text-[14px] font-sans text-[#FFFFFF] font-semibold ml-3 mt-[9px] mr-3 mb-[9px]">Approve</span>
            </div>
          </button>
        </div>
      </div>
  ...
  methods: {
    ...
    async postAproval(successFunction, failFunction) {
      ...
      if (this.base == "PKS") {
        ...
        const position = localStorage.getItem('position')
        if (position == "PartnershipManager") {
          url = `mitra/manager/pks/approval/${this.id}`;
        } else if (position == "PartnershipVP") {
          url = `mitra/vp/pks/approval/${this.id}`;
        } else if (position == "PartnershipDirector") {
    ...
    async postTolak(successFunction, failFunction) {
      ...
      if (this.base == "PKS") {
        ...
        const position = localStorage.getItem('position')
        if (position == "PartnershipManager") {
          url = `mitra/manager/pks/approval/${this.id}/reject`;
        } else if (position == "PartnershipVP") {
          url = `mitra/vp/pks/approval/${this.id}/reject`;
        } else if (position == "PartnershipDirector") {
