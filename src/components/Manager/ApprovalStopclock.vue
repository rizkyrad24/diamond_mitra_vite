  ...
  <div class="px-4 py-3">
    <div class="h-[776px] w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
      ...
      <h1 class="items-start justify-center px-2 ml-2 text-[#9C9C9C]">
        Persetujuan Pengajuan Mitra
      </h1>
      <button
        class="flex-grow w-[129px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4"
...
export default {
  ...
  methods: {
    ...
    navigateToDetail(tipe, id) {
      ...
      this.$router.push(`/mitra/approval/approvalstopclock/detailpengajuanapprovalstopclock/${base}/${id}`);
    },
