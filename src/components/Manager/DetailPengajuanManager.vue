    ...
    <div class="px-4 py-3">
      <div class="relative h-auto w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
        ...
        <button
          ...
          class="absolute top-[12px] right-[24px]"
          @click="showDisposePopup = true"
        >
          <div
            class="flex items-center justify-center w-[81px] h-[40px] rounded-lg bg-[#2671D9] hover:bg-[#1E5BB7] border-[1px] border-[#E5E7E9]"
          >
            <span
              class="w-[57px] h-[22px] text-[14px] font-sans font-medium text-[#FFFFFF] ml-3 mt-[9px] mr-3 mb-[9px]"
            >Dispose</span>
          </div>
        </button>
        <div
          v-if="showDisposePopup"
        ...
        >
          <div class="bg-[#FFFFFF] rounded-lg shadow-lg w-[502px] h-[304px]">
            ...
            <div class="p-6">
              <p class="text-[16px] font-sans text-[#333333] font-normal">
                Silakan pilih nama staff kemitraan untuk
                dispose pengajuan.
              </p>
              <label
                for="staffKemitraan"
                class="block mt-4 text-[16px] font-sans text-[#4D5E80] font-medium"
              >Staff
                Kemitraan *</label>
              <div class="relative">
                <SelectSearch
            ...
            <div class="flex justify-end mr-6">
              <button
                class="w-[50px] h-[40px] mr-3 p-2 rounded-lg bg-[#FFFFFF] hover:bg-[#FEE2E2] text-[#FF5656] font-sans text-[14px] font-semibold transition-all"
                @click="closePopup"
              >
                Batal
              </button>
        ...
        >
          <div
            ...
            class="flex items-center overflow-x-auto w-[1046px] max-h-[430px] bg-[#FFFFFF] border-[#E5E7E9] border-[1px] ml-4 px-6 py-6 rounded-bl-md rounded-br-md"
          >
        ...
        <div
          v-if="position == 'PartnershipVP'"
          class="flex flex-row w-[1046px] h-auto ml-4 py-7"
        >
          <button
