      ...
      <div>
            ...
            <table class="table-auto w-full h-auto text-left border-collapse border border-[#E5E7E9]">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="p-2 py-4 border border-[#E5E7E9] text-center">
        ...
        <div class="flex items-center justify-between p-4">
          ...
          <div class="flex items-center rounded-lg border-transparent text-[14px] font-sans font-normal border-[#FFFFFF]">
            ...
            <button
              class="pagination-btn font-sans font-normal"
      ...
      const params = null
        ...
        this.modalFailed = {
          ...
          message: res.data.message ? res.data.message : "Silahkan hubungi admin"
			...
			const res2 = await fetchGet("mitra/staff/pks/incoming-data", params, this.$router);
			if (res2.status == 200) {
