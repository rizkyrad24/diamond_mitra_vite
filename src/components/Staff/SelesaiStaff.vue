<template>
  ...
  <div class="px-4 py-3">
    <div class="h-[776px] w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
      ...
      <button
        :class="['flex-grow w-[56px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-4 mr-4', selectedTable === 'ApprovalDitolakStaff' ? 'text-[#2671D9]' : 'text-[#333333]']"
        @click="navigateToDitolakStaff"
      >
        Ditolak
      </button>
            ...
            <table class="table-auto w-full text-left border-collapse border border-[#E5E7E9]">
              <thead>
                <tr class="bg-[#FFFFFF] text-[12px] font-sans text-[#4D5E80] font-semibold">
                  ...
                  <th class="p-2 border border-[#E5E7E9] w-[150px]">
                    <div class="flex items-center justify-between">
