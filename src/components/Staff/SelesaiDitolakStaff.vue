  ...
  methods: {
    ...
    navigateToDetail(tipe, id) {
      if (tipe.toUpperCase() === "PKS") {
        this.$router.push(`/mitra/selesaistaff/detailpengajuanpksstaff/${id}?origin=ditolak`);
      } else if (tipe.toUpperCase() === "MOU" || tipe.toUpperCase() === "NDA") {
        this.$router.push(`/mitra/selesaistaff/detailpengajuanmoustaff/${id}?origin=ditolak`);
      }
    },
