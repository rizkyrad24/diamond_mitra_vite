        ...
        >
          <div class="bg-[#FFFFFF] rounded-lg shadow-lg w-[502px] h-[596px]">
            <div class="flex w-[502px] h-[76px] bg-[#E9F1FB] border-[#DEDEDE] rounded-tl-lg rounded-tr-lg">
              <h1 class="w-[380px] h-[28px] ml-6 mt-6 font-sans font-bold text-[20px] text-[#000000]">
            ...
            <div class="flex flex-col justify-start items-start mt-4 ml-6 mr-8">
              <h1 class="w-[454px] h-[56px] items-start text-[16px] font-sans font-normal text-[#333333] mb-2">
                Silahkan mengisi form berikut untuk penyelesaian dokumen MoU/NDA.
              </h1>
              <div class="relative flex flex-col w-[454.5px] h-[72px]">
                <div class="flex items-center">
                  <h1 class="w-[140px] h-[24px] font-sans text-[16px] font-bold text-[#4D5E80]">
                    Nomor MoU/NDA
                  </h1>
...
export default {
  ...
  computed: {
    ...
    allFilesUploaded() {
      return this.fileId1 && this.fileId2 && this.fileId3 && !this.file1 && !this.file2 && !this.file3;
    },
    boxClass1() {
