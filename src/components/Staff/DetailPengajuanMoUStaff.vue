...
<template>
  ...
  <div>
    <div class="flex w-auto h-[54px] rounded-lg bg-[#FFFFFF] border-collapse">
      ...
      <svg width="8" height="12" class="mt-[21px] mr-1" viewBox="0 0 8 12" fill="none"
      ...
      <span class="w-[119px] h-[22px] font-sans text-[#7F7F80] text-[14px] font-semibold ml-2 mt-[17px]">Detail
        Pengajuan</span>
    </div>
    <div class="px-4 py-3">
      <div class="relative h-auto w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
        <div class="flex">
          <svg class="ml-4 mt-[18px]" width="6" height="28" viewBox="0 0 6 28" fill="none"
            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex">
                  <div :class="boxClass1"
                    ...
                    <div :class="headerClass1"
                      ...
                      <div class="font-sans text-[14px] font-semibold text-white">{{ fileUploaded1 ? "Surat Penawaran" :
                        "Surat Penawaran" }}</div>
                    </div>
                    <div v-if="!fileUploaded1" class="flex flex-col ml-4 mt-[10px]">
                      ...
                      <label
                        ...
                        <div class="flex items-center">
                          <svg class="mr-1" width="9" height="7" viewBox="0 0 9 7" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div v-else class="flex items-center ml-4 mt-[10px]">
                      <div class="flex items-center">
                        ...
                        <svg class="w-[30px] h-[30px] absolute ml-[2px] mt-[30px]" viewBox="0 0 30 30" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                          <circle cx="15" cy="15" r="14.5652" class="fill-[#E2FCF3]" />
                          <g transform="translate(9, 8)">
                            <path class="fill-[#0EA976]"
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-[33px] h-[28px] absolute ml-[325px] mt-[90px]"
                    viewBox="0 0 33 28" fill="none">
                    <path d="M24.75 6.91797L31.8317 13.9996L24.75 21.0813" stroke="#292D32" stroke-width="1.5"
                      stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M1 14H30.64" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10"
                      stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                  <div :class="[!fileUploaded1 ? 'bg-[#FFFFFF]' : boxClass2]"
                    class="flex flex-col w-[289px] h-[130px] rounded-lg mt-6 ml-[370px] absolute border-[1px] border-[#DEDEDE]">
                    <div :class="!fileUploaded1 ? 'bg-[#E0E0E0]' : headerClass2"
                      class="w-full h-[40px] p-4 flex justify-between items-center rounded-t-lg">
                      <div :class="!fileUploaded1 ? 'text-[#333333]' : 'text-[#FFFFFF]'"
                        class="font-sans text-[14px] font-semibold">{{ fileUploaded3 ? "Proposal" : "Proposal" }}</div>
                    </div>
                    <div v-if="!fileUploaded2" class="flex flex-col ml-4 mt-[10px]">
                      <p :class="!fileUploaded1 ? 'text-[#7F7F80]' : 'text-[#333333]'"
                        class="font-sans text-[12px] font-normal">Dokumen Proposal</p>
                      <label
                        ...
                        <div class="flex items-center">
                          <svg class="mr-1" width="9" height="7" viewBox="0 0 9 7" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path :fill="!fileUploaded1 ? '#7F7F80' : '#FFFFFF'" fill-rule="evenodd" clip-rule="evenodd"
                              d="M3.87337 1.13053C3.01762 1.13053 2.32389 1.82426 2.32389 2.68001C2.32389 2.77881 2.33309 2.87512 2.35059 2.96824C2.38432 3.14782 2.27992 3.32463 2.10638 3.38182C1.59703 3.54968 1.23014 4.02951 1.23014 4.59407C1.23014 5.29881 1.80145 5.87012 2.50618 5.87012H6.60775C7.16147 5.87012 7.61035 5.42124 7.61035 4.86751C7.61035 4.43975 7.3423 4.07368 6.96375 3.92985C6.77894 3.85963 6.68377 3.65491 6.74921 3.46836C6.77555 3.39326 6.79004 3.31216 6.79004 3.22689C6.79004 2.82418 6.46358 2.49772 6.06087 2.49772C5.98167 2.49772 5.9061 2.51022 5.83562 2.53308C5.74043 2.56395 5.63673 2.55433 5.54884 2.50649C5.46095 2.45864 5.39658 2.37677 5.37084 2.28007C5.19455 1.61791 4.59041 1.13053 3.87337 1.13053ZM1.59473 2.68001C1.59473 1.42155 2.61491 0.401367 3.87337 0.401367C4.80935 0.401367 5.61285 0.965434 5.96369 1.77176C5.99584 1.76963 6.02825 1.76855 6.06087 1.76855C6.86629 1.76855 7.51921 2.42147 7.51921 3.22689C7.51921 3.28171 7.51616 3.33591 7.51023 3.3893C8.00728 3.69338 8.33952 4.24132 8.33952 4.86751C8.33952 5.82394 7.56418 6.59928 6.60775 6.59928H2.50618C1.39874 6.59928 0.500977 5.70152 0.500977 4.59407C0.500977 3.81305 0.947312 3.13701 1.59815 2.80588C1.59588 2.76418 1.59473 2.72222 1.59473 2.68001ZM4.16245 2.42221C4.30483 2.27983 4.53567 2.27983 4.67805 2.42221L5.7718 3.51596C5.91418 3.65834 5.91418 3.88918 5.7718 4.03156C5.62942 4.17394 5.39858 4.17394 5.2562 4.03156L4.78483 3.56019L4.78483 5.14095C4.78483 5.3423 4.6216 5.50553 4.42025 5.50553C4.21889 5.50553 4.05566 5.3423 4.05566 5.14095L4.05566 3.56019L3.5843 4.03156C3.44192 4.17394 3.21108 4.17394 3.0687 4.03156C2.92632 3.88918 2.92632 3.65834 3.0687 3.51596L4.16245 2.42221Z" />
                          </svg>
                          <span>Upload</span>
                        </div>
                    ...
                    <div v-else class="flex items-center ml-4 mt-[10px]">
                      <div class="flex items-center">
                        ...
                        <svg class="w-[30px] h-[30px] absolute mt-[30px]" viewBox="0 0 30 30" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                          <circle cx="15" cy="15" r="14.5652" class="fill-[#E2FCF3]" />
                          <g transform="translate(9, 8)">
                            <path class="fill-[#0EA976]"
                  ...
                  <svg width="28" height="33" class="mt-[180px] ml-[195px]" viewBox="0 0 28 33" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div :class="[!fileUploaded2 ? 'bg-[#FFFFFF]' : boxClass3]"
                    class="absolute flex flex-col w-[289px] h-[130px] rounded-lg mt-[240px] ml-[370px] border-[1px] border-[#DEDEDE]">
                    <div :class="!fileUploaded2 ? 'bg-[#E0E0E0]' : headerClass3"
                      class="w-full h-[40px] p-4 flex justify-between items-center rounded-t-lg">
                      <div :class="!fileUploaded2 ? 'text-[#333333]' : 'text-[#FFFFFF]'"
                        class="font-sans text-[14px] font-semibold">{{ fileUploaded3 ? "MoU/NDA" : "MoU/NDA" }}</div>
                    </div>
                    <div v-if="!fileUploaded3" class="flex flex-col ml-4 mt-[10px]">
                      <p :class="!fileUploaded2 ? 'text-[#7F7F80]' : 'text-[#333333]'"
                        class="font-sans text-[12px] font-normal">Dokumen MoU/NDA</p>
                      <label
                        ...
                        <div class="flex items-center">
                          <svg class="mr-1" width="9" height="7" viewBox="0 0 9 7" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path :fill="!fileUploaded2 ? '#7F7F80' : '#FFFFFF'" fill-rule="evenodd" clip-rule="evenodd"
                              d="M3.87337 1.13053C3.01762 1.13053 2.32389 1.82426 2.32389 2.68001C2.32389 2.77881 2.33309 2.87512 2.35059 2.96824C2.38432 3.14782 2.27992 3.32463 2.10638 3.38182C1.59703 3.54968 1.23014 4.02951 1.23014 4.59407C1.23014 5.29881 1.80145 5.87012 2.50618 5.87012H6.60775C7.16147 5.87012 7.61035 5.42124 7.61035 4.86751C7.61035 4.43975 7.3423 4.07368 6.96375 3.92985C6.77894 3.85963 6.68377 3.65491 6.74921 3.46836C6.77555 3.39326 6.79004 3.31216 6.79004 3.22689C6.79004 2.82418 6.46358 2.49772 6.06087 2.49772C5.98167 2.49772 5.9061 2.51022 5.83562 2.53308C5.74043 2.56395 5.63673 2.55433 5.54884 2.50649C5.46095 2.45864 5.39658 2.37677 5.37084 2.28007C5.19455 1.61791 4.59041 1.13053 3.87337 1.13053ZM1.59473 2.68001C1.59473 1.42155 2.61491 0.401367 3.87337 0.401367C4.80935 0.401367 5.61285 0.965434 5.96369 1.77176C5.99584 1.76963 6.02825 1.76855 6.06087 1.76855C6.86629 1.76855 7.51921 2.42147 7.51921 3.22689C7.51921 3.28171 7.51616 3.33591 7.51023 3.3893C8.00728 3.69338 8.33952 4.24132 8.33952 4.86751C8.33952 5.82394 7.56418 6.59928 6.60775 6.59928H2.50618C1.39874 6.59928 0.500977 5.70152 0.500977 4.59407C0.500977 3.81305 0.947312 3.13701 1.59815 2.80588C1.59588 2.76418 1.59473 2.72222 1.59473 2.68001ZM4.16245 2.42221C4.30483 2.27983 4.53567 2.27983 4.67805 2.42221L5.7718 3.51596C5.91418 3.65834 5.91418 3.88918 5.7718 4.03156C5.62942 4.17394 5.39858 4.17394 5.2562 4.03156L4.78483 3.56019L4.78483 5.14095C4.78483 5.3423 4.6216 5.50553 4.42025 5.50553C4.21889 5.50553 4.05566 5.3423 4.05566 5.14095L4.05566 3.56019L3.5843 4.03156C3.44192 4.17394 3.21108 4.17394 3.0687 4.03156C2.92632 3.88918 2.92632 3.65834 3.0687 3.51596L4.16245 2.42221Z" />
                          </svg>
                          <span>Upload</span>
                        </div>
                  ...
                  <!-- <button @click="handleKirimClick"
                    ...
                    :disabled="!allFilesUploaded" class="absolute mt-[405px] ml-[577px] flex">
                    <div
                  ...
                  <button v-if="!allFilesUploaded" @click="SendFile"
                    class="absolute mt-[405px] ml-[577px] flex bg-[#2671D9] hover:bg-[#1E5BB7] text-[#FFFFFF] rounded-lg border-[#FFFFFF] border-[1px]">
                    <div
                      class="flex items-center justify-center w-[83px] h-[40px] rounded-lg border-[#FFFFFF] border-[1px]">
                      <span class="text-[14px] font-sans font-semibold ml-3 mt-[9px] mr-3 mb-[9px]">Submit</span>
                    </div>
        ...
        <div
          ...
          <div class="text-[16px] font-sans font-semibold text-[#333333] ml-[10px] mt-[14.5px] mb-[14.5px]">Dokumen
            Progress Kemitraan</div>
          <button @click="toggleDropdownArrow4" class="ml-auto mr-4 flex py-1 px-1 rounded-full hover:bg-[#FFFFFF]">
            <svg :class="{ 'rotate-180': isDropdownArrowOpen4 }" class="w-4 h-4 text-[#2671D9]" fill="none"
              stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
          </button>
              ...
              <div
                ...
                <div class="flex items-center p-4 bg-[#FFFFFF] border border-[#E5E7E9] rounded-lg w-full">
                  ...
                  <div class="relative w-full">
                    <!-- Input file yang tersembunyi -->
                    <input type="file" id="fileInputSuratPenawaran" class="hidden" @change="handleFileUpload1($event)"
        ...
        <div class="flex flex-row w-[1046px] h-auto py-4 ml-4">
          ...
          <div class="flex flex-col w-[520px] h-auto ml-4">
            ...
            <textarea v-model="ApprovalNote" type="text" placeholder="Masukkan catatan approval"
              class="w-full h-[88px] text-black font-sans text-sm focus:border-gray-400 focus:outline-none border border-gray-300 rounded-lg p-2 mt-2 bg-white"></textarea>
          </div>
        </div>
        ...
        <div class="flex w-[1046px] h-auto ml-4 py-9 justify-end gap-6">
          ...
          <button v-if="statusAction == 1" @click="showPenyelesaianMoUPopup = true"
    ...
    async postFileMounda(successFunction, failFunction) {
      ...
      if (this.fileDetails.DokumenSuratMenyurat.file || this.fileDetails.DokumenSuratMenyurat.fileId) {
        if (this.fileDetails.DokumenSuratMenyurat.file) {
          ...
          form.append(`attachmentsMou[${sort}].file`, this.fileDetails.DokumenSuratMenyurat.file)
          if (this.fileDetails.DokumenSuratMenyurat.fileId) {
            form.append(`attachmentsMou[${sort}].id`, this.fileDetails.DokumenSuratMenyurat.fileId)
          }
          sort++
        }
      }
      if (this.fileDetails.ProposalMitra.file || this.fileDetails.ProposalMitra.fileId) {
        if (this.fileDetails.ProposalMitra.file) {
          ...
          form.append(`attachmentsMou[${sort}].file`, this.fileDetails.ProposalMitra.file)
          if (this.fileDetails.ProposalMitra.fileId) {
            form.append(`attachmentsMou[${sort}].id`, this.fileDetails.ProposalMitra.fileId)
          }
          sort++
        }
      }
      if (this.fileDetails.DokumenLainnya.file || this.fileDetails.DokumenLainnya.fileId) {
        if (this.fileDetails.DokumenLainnya.file) {
          ...
          form.append(`attachmentsMou[${sort}].file`, this.fileDetails.DokumenLainnya.file)
          if (this.fileDetails.DokumenLainnya.fileId) {
            form.append(`attachmentsMou[${sort}].id`, this.fileDetails.DokumenLainnya.fileId)
          }
          sort++
        }
      }
