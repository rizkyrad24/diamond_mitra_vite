  ...
  <div class="flex flex-col items-start p-4 w-[248px] h-[1416px] bg-white border-r border-neutral-stroke">
    ...
    <div @click="navigateToDetail" class="flex justify-between items-center w-[216px] h-[27px] mt-4 cursor-pointer">
      <svg width="77" height="13" viewBox="0 0 77 13" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <defs>
          ...
          <image id="image0_1974_2101" width="251" height="44"
    ...
    <div class="flex flex-col w-full gap-[8px]">
      ...
      <button
        ...
        <svg class="ml-[5px] mr-[14px]" width="18" height="18" viewBox="0 0 18 18" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M9.27759 6.66H13.2151H9.27759Z" fill="white" />
          <path d="M9.27759 6.66H13.2151" :stroke="isActive('User') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 6.66L5.34741 7.2225L7.03491 5.535"
            :stroke="isActive('User') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
          <path d="M9.27759 11.91H13.2151" :stroke="isActive('User') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 11.91L5.34741 12.4725L7.03491 10.785"
            :stroke="isActive('User') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
          <path
      ...
      <button
        :class="['flex text-[14px] font-sans font-semibold items-center justify p-2 rounded-lg transition-colors', isActive('SelesaiStaff') ? 'bg-[#2671D9] text-[#FFFFFF]' : 'text-[#333333] hover:bg-[#DBEAFE]']"
        @click="navigateTo('Pejabat')">
        <svg class="ml-[5px] mr-[14px]" width="18" height="18" viewBox="0 0 18 18" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M9.27759 6.66H13.2151H9.27759Z" fill="white" />
          <path d="M9.27759 6.66H13.2151" :stroke="isActive('Pejabat') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 6.66L5.34741 7.2225L7.03491 5.535"
            :stroke="isActive('Pejabat') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
          <path d="M9.27759 11.91H13.2151" :stroke="isActive('Pejabat') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 11.91L5.34741 12.4725L7.03491 10.785"
            :stroke="isActive('Pejabat') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
      ...
      <button
        :class="['flex text-[14px] font-sans font-semibold items-center justify p-2 rounded-lg transition-colors', isActive('SelesaiStaff') ? 'bg-[#2671D9] text-[#FFFFFF]' : 'text-[#333333] hover:bg-[#DBEAFE]']"
        @click="navigateTo('Pelanggan')">
        <svg class="ml-[5px] mr-[14px]" width="18" height="18" viewBox="0 0 18 18" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M9.27759 6.66H13.2151H9.27759Z" fill="white" />
          <path d="M9.27759 6.66H13.2151" :stroke="isActive('Pelanggan') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 6.66L5.34741 7.2225L7.03491 5.535"
            :stroke="isActive('Pelanggan') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
          <path d="M9.27759 11.91H13.2151" :stroke="isActive('Pelanggan') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 11.91L5.34741 12.4725L7.03491 10.785"
            :stroke="isActive('Pelanggan') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
      ...
      <button
        :class="['flex text-[14px] font-sans font-semibold items-center justify p-2 rounded-lg transition-colors', isActive('SelesaiStaff') ? 'bg-[#2671D9] text-[#FFFFFF]' : 'text-[#333333] hover:bg-[#DBEAFE]']"
        @click="navigateTo('Produk')">
        <svg class="ml-[5px] mr-[14px]" width="18" height="18" viewBox="0 0 18 18" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M9.27759 6.66H13.2151H9.27759Z" fill="white" />
          <path d="M9.27759 6.66H13.2151" :stroke="isActive('Produk') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 6.66L5.34741 7.2225L7.03491 5.535"
            :stroke="isActive('Produk') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
          <path d="M9.27759 11.91H13.2151" :stroke="isActive('Produk') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 11.91L5.34741 12.4725L7.03491 10.785"
            :stroke="isActive('Produk') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
      ...
      <button
        :class="['flex text-[14px] font-sans font-semibold items-center justify p-2 rounded-lg transition-colors', isActive('SelesaiStaff') ? 'bg-[#2671D9] text-[#FFFFFF]' : 'text-[#333333] hover:bg-[#DBEAFE]']"
        @click="navigateTo('Candidate')">
        <svg class="ml-[5px] mr-[14px]" width="18" height="18" viewBox="0 0 18 18" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M9.27759 6.66H13.2151H9.27759Z" fill="white" />
          <path d="M9.27759 6.66H13.2151" :stroke="isActive('Candidate') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 6.66L5.34741 7.2225L7.03491 5.535"
            :stroke="isActive('Candidate') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
          <path d="M9.27759 11.91H13.2151" :stroke="isActive('Candidate') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3"
            stroke-linecap="round" stroke-linejoin="round" />
          <path d="M4.78491 11.91L5.34741 12.4725L7.03491 10.785"
            :stroke="isActive('Candidate') ? '#FFFFFF' : '#2671D9'" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
